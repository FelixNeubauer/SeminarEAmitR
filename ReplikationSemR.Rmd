...
prettydoc/html_pretty und Bootstrap hängen automatisch die Klasse `.table` an
HTML-Tabellen; diese Klasse wird hier rein über CSS für die replizierten
Tabellen neutralisiert, damit die früheren Überblickstabellen weiterhin das
prettydoc-Design behalten.
*/
.replicated-original-table,
.replicated-original-table.table {
...
.replicated-original-table.table > :not(caption) > * > *,
.replicated-original-table th,
.replicated-original-table td {
  background-color: transparent !important;
  background-image: none !important;
  box-shadow: none !important;
}

.replicated-original-table.table-hover > tbody > tr:hover > *,
.replicated-original-table.table-striped > tbody > tr:nth-of-type(odd) > * {
