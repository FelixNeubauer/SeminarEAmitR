...
plot_data_grafik1_monat <- ggplot(
  ...
  scale_fill_manual(
    ...
    labels = c(
      "Panel A: Neue U-Bahn-Linien",
      "Panel B: Existierende oder geplante U-Bahn-Linien in Treated Cities",
      "Panel C: Existierende oder geplante U-Bahn-Linien in Control Cities"
    )
  ) +
  scale_shape_manual(
    name = "\nStatus",
  ...
  labs(
    title = "Eröffnungsdaten der Linien im Sample",
...
##### Figure 2
```{r fig2_data, echo=FALSE, dpi=300}
...
p_fig2_b <- plot_fig2_panel(fig2_b_df, "Panel B. Two-way fixed effects,\nnot accounting for seasonality")
p_fig2_c <- plot_fig2_panel(fig2_c_df, "Panel C. Two-way fixed effects,\naccounting for seasonality")
```


```{r fig2_panel_a, include=FALSE, dpi=300, fig.width=7, fig.height=4.5, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 2 aus Gu et. al (2021)'}
# Panel A separat ausgeben
p_fig2_a
```


```{r fig2_panel_b, include=FALSE, dpi=300, fig.width=7, fig.height=4.5, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 2 aus Gu et. al (2021)'}
# Panel B separat ausgeben
p_fig2_b
```


```{r fig2_panel_c, include=FALSE, dpi=300, fig.width=7, fig.height=4.5, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 2 aus Gu et. al (2021)'}
# Panel C separat ausgeben
p_fig2_c
```


```{r fig2_combined, echo=FALSE, dpi=300, fig.width=10, fig.height=7.5, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 2 aus Gu et. al (2021)'}
...
kableExtra::kbl(
  ...
  kableExtra::footnote(
    general = paste0(
      ...
      "Standard errors are in parentheses, clustered at the group level in column 1, ",
      "clustered at the subway line level in columns 2 and 3."
    ),
    general_title = "Notes:",
    footnote_as_chunk = TRUE,
    escape = FALSE
...
```{r fig3_plot, echo=FALSE, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 3 aus Gu et. al (2021)',dpi=300}
...
```{r fig3_save_figma, include=FALSE}
# Grafik als PNG speichern
ggsave(
  filename = "FertigeGrafiken/Fig3_R_Figma.png",
  plot = p_fig3
)
...
```{r table4_output, results='asis', echo=FALSE}
...
```{r fig4_plot, echo=FALSE, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 4 aus Gu et. al (2021)', dpi=300}
...
```{r fig4_save, include=FALSE}
# Grafik als PNG speichern
ggsave(
  filename = "FertigeGrafiken/Fig4_R.png",
  plot = p_fig4
)
...
##### Figure 5
```{r fig5_data, echo=FALSE, message=FALSE, warning=FALSE, dpi=300}
...
p_fig5_b <- plot_fig5_panel(
  fig5_b_df,
  "Panel B. Lines launched between February 1, 2017\nand November 30, 2017",
...
```{r fig5_combined, echo=FALSE, fig.width=10, fig.height=7.5, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 5 aus Gu et. al (2021)', dpi=300}
# Drei Panels zu einer Abbildung kombinieren
(
  (p_fig5_a | p_fig5_b) /
...
```{r fig5_save_figma, include=FALSE, fig.width=10, fig.height=7.5, dpi=300}
# Grafik als PNG speichern
ggsave(
  filename = "FertigeGrafiken/Fig5_R_Figma.png",
  plot = (
  (p_fig5_a | p_fig5_b) /
  (p_fig5_c | plot_spacer())
) +
...
```{r fig6_plot, echo=FALSE, fig.width=7.4, fig.height=7.4, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 6 aus Gu et. al (2021)', dpi=300}
...
```{r fig7_plot, echo=FALSE, fig.width=7.2, fig.height=5.7, fig.cap='Grafik selbst erstellt in Anlehnung an Figure 7 aus Gu et. al (2021)', dpi=300}
